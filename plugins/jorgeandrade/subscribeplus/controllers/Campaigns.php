...
class Campaigns extends Controller
{
    ...
    public function onStoreCampaign()
    {
        ...
        return \Redirect::to(Url::to("backend/jorgeandrade/subscribeplus/campaigns/preview/{$campaign->id}"));
    }
    ...
    public function onDeleteCampaign($recordId)
    {
        ...
        return Redirect::to('/backend/jorgeandrade/subscribeplus/campaigns/preview/' . $campaign->id);
    }
